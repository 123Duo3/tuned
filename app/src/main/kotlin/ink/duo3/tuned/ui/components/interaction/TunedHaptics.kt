package ink.duo3.tuned.ui.components.interaction
...
fun View.performTunedEndpointHapticFeedback() {
    performHapticFeedback(tunedEndpointHapticFeedbackConstant())
}
...
private fun tunedEndpointHapticFeedbackConstant(): Int =
